...
const en: Dict = {
  ...
  hero: {
    headline: "The best place for kite gear in",
    country: "Portugal",
    subhead:
  ...
  problem: {
    ...
    bullets: [
      ...
      "Post your gear for sale and get zero replies — your ad drowns in an ocean of messages before any buyer even notices",
    ],
  },
  listings: {
